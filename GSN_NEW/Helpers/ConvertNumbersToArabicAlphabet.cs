    ...
    class ConvertNumbersToArabicAlphabet
    {
        ...
        {            
            ...
            if (Number.Contains("."))
            {
                ...
                SecondNo = " و " + ConvertNumberToAlpha(decimals);
            }
        }
        private string ConvertNumberToAlpha(string Number)
        {
            if (Number.Contains('.'))
            {
                ...
                else
                {
                    ...
                    {
                        case 1: return convertOneDigits(Number.ToString()) + "" ;
                        case 2: return convertTwoDigits(Number.ToString()) + "" ;
                        case 3: return convertThreeDigits(Number.ToString()) + "" ;
                        case 4: return convertFourDigits(Number.ToString()) + "" ;
                        case 5: return convertFiveDigits(Number.ToString()) + "";
                        case 6: return convertSixDigits(Number.ToString()) + "";
                        default: return "";
                    }
        ...
        public string GetNumberAr()
        {
            ...
            return String.IsNullOrWhiteSpace(SecondNo)?NumberAr+" شيكل":NumberAr+" شيكل"+SecondNo+" اغورة";
        }
